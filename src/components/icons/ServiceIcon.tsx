<svg xmlns="http://www.w3.org/2000/svg" width="89" height="57" viewBox="0 0 89 57" fill="none">
  ...
  <defs>
    ...
    >
      ...
      <stop offset="0.2" stop-color="#5AA4FF" />
      <stop offset="0.4" stop-color="#5AA5FF" />
      <stop offset="0.7" stop-color="#4481FD" />
      <stop offset="1" stop-color="#2653FC" />
    </linearGradient>
    <linearGradient
      id="paint1_linear_88_3157"
      x1="69.5"
      y1="10.5"
      x2="69.5"
      y2="54.125"
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop stop-color="#C6FFFF" />
      <stop offset="0.2" stop-color="#B9F0FF" />
      <stop offset="0.7" stop-color="#A6DAFF" />
      <stop offset="1" stop-color="#9FD2FF" />
    </linearGradient>
    <linearGradient
      id="paint3_linear_88_3157"
      x1="43.75"
      y1="15.375"
      x2="43.75"
      y2="51.125"
    ...
    >
      <stop stop-color="#66B6FF" />
      <stop offset="0.2" stop-color="#5AA5FF" />
      <stop offset="0.3" stop-color="#5AA4FF" />
      <stop offset="0.6" stop-color="#4481FD" />
      <stop offset="1" stop-color="#2653FC" />
    </linearGradient>
  </defs>
</svg>;
