  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 gap-16">
        ...
        <section className="max-w-2xl text-center flex flex-col gap-6">
          ...
          <div>
            <button
              ...
              className="bg-blue-600 text-white px-8 py-3 rounded-xl font-semibold text-base hover:bg-blue-700 active:scale-95 transition-all duration-150 shadow-sm cursor-pointer"
            >
              → 대시보드 바로가기
            </button>
          </div>
        ...
        {/* Feature cards */}
        <section className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-3 gap-6">
